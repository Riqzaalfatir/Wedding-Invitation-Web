...
const WeddingEvent = () => {
  ...
  <div className="max-w-6xl mx-auto px-5 sm:px-6 md:px-8 lg:px-4">
    ...
    <h2
      data-aos="fade-up"
      className={`${libre.className} font-medium text-[30px] sm:text-[34px] md:text-[36px] lg:text-[40px] text-[#082B21] mb-[30px] md:mb-[40px] lg:mb-[45px]`}
    >
      Wedding Event
    </h2>
    ...
    <h3
      data-aos="fade-up"
      data-aos-delay="100"
      className={`${ibm.className} font-semibold text-[20px] sm:text-[24px] md:text-[26px] lg:text-[30.75px] text-[#082B21] mb-[30px] md:mb-[40px] lg:mb-[45.35px] text-center`}
    >
    ...
    <div>
      ...
      <h2
        data-aos="fade-up"
        className={`${libre.className} font-medium text-[30px] md:text-[34px] lg:text-[40px] text-[#082B21]`}
      >
        Dresscode
      </h2>
      ...
      <p
        data-aos="fade-up"
        data-aos-delay="100"
        className={`${ibm.className} text-[15px] md:text-[16px] lg:text-[18px] text-[#082B21] mb-[19px]`}
      >
      ...
      <div className="flex flex-wrap md:flex-nowrap items-center gap-[14px] md:gap-[21.04px] md:justify-start sm:mb-0 mb-40">
        ...
        <img data-aos="zoom-in" data-aos-delay="0" src="/dc1.png" alt="" className="w-[44px] md:w-[70px] lg:w-[85px]" />
        <img data-aos="zoom-in" data-aos-delay="100" src="/dc2.png" alt="" className="w-[44px] md:w-[70px] lg:w-[85px]" />
        <img data-aos="zoom-in" data-aos-delay="200" src="/dc3.png" alt="" className="w-[44px] md:w-[70px] lg:w-[85px]" />
        <img data-aos="zoom-in" data-aos-delay="300" src="/dc4.png" alt="" className="w-[44px] md:w-[70px] lg:w-[85px]" />
        <img data-aos="zoom-in" data-aos-delay="400" src="/dc5.png" alt="" className="w-[44px] md:w-[70px] lg:w-[85px]" />
