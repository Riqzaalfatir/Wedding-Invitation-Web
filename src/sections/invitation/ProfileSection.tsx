...
const ProfileSection = () => {
  ...
  <div className="flex flex-col items-center p-[25px] sm:p-[40px] gap-12 px-6 lg:hidden">
    ...
    <div 
      data-aos="zoom-in"
      className="relative w-[250px] h-[270px] sm:w-[380px] sm:h-[400px]"
    >
      <Image
        src="/couple.png"
        alt="couple"
  ...
  <div className="hidden lg:block">
    ...
    <div 
      data-aos="fade-right"
      className="absolute left-[calc(50%-199px-280px)] top-1/2 -translate-y-1/2 text-right w-[260px]"
    >
    ...
    <div 
      data-aos="fade-left"
      className="absolute right-[calc(50%-199px-280px)] top-1/2 -translate-y-1/2 text-left w-[260px]"
    >
