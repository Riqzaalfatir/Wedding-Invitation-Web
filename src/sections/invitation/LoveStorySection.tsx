...
const LoveStorySection = () => {
  ...
  <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14 md:px-8 lg:px-4 lg:p-0">
    ...
    <div className="flex flex-col md:flex-row items-center justify-center gap-[16px] md:gap-[20px]">
      ...
      <div
        data-aos="zoom-in"
        className="relative h-[220px] md:h-[260px] lg:h-[281px] w-[150px] md:w-[170px] lg:w-[190px]"
      >
      ...
      <div
        data-aos="zoom-in"
        data-aos-delay="150"
        className="relative h-[220px] md:h-[260px] lg:h-[281px] w-[280px] md:w-[340px] lg:w-[400px]"
      >
  ...
  {/* ORNAMENT */}
  <img data-aos="fade-right" src="/OrnamenKiriAtas.png" className="absolute top-0 left-0 w-[120px] md:w-[170px] lg:w-[208px] z-10" />
  <img data-aos="fade-left" src="/OrnamenKananAtas.png" className="absolute top-0 right-0 w-[120px] md:w-[170px] lg:w-[208px] z-10" />
  <img data-aos="fade-right" src="/OrnamenKiriBawah.png" className="absolute bottom-0 left-0 w-[120px] md:w-[170px] lg:w-[208px] z-10" />
  <img data-aos="fade-left" src="/OrnamenKananBawah.png" className="absolute bottom-0 right-0 w-[120px] md:w-[170px] lg:w-[208px] z-10" />
