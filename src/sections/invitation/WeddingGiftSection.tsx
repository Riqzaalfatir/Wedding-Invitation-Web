...
>
  ...
  <div className="relative z-10 max-w-6xl mx-auto px-6 sm:px-8 md:px-10 lg:px-4 pt-[120px] sm:pt-[140px] md:pt-[150px] lg:pt-[161px]">
    ...
    <div className="flex flex-col md:flex-row gap-8 md:gap-6">
      ...
      {/* CONTENT */}
      <div className="md:pt-20 max-w-md" data-aos="fade-up" data-aos-delay="200">
        ...
        {/* BANK */}
        <div className="flex justify-between items-end gap-3 mb-[17.84px]" data-aos="fade-up" data-aos-delay="300">
